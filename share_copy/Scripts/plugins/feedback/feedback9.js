    ...
    $(document).ready(function () {
        ...
        AxLib.utils.retryUntilTruthy(function () {
            ...
            var props = {
                ...
                shortcut: window.$axure.player.settings.projectId
            };

            var handlers = {
                "onIssuesLoaded": function () {
                    $axure.messageCenter.postMessage("cloud_feedbackLoaded", {});
                },

                "onUpdateHasNewComments": function (payload) {
                    $axure.messageCenter.postMessage("cloud_updateHasNewComments", payload);
                },

                "onPageShouldChange": function (payload) {
                ...
                "onPinsToggled": function (pinsEnabled) {
                ...
                "onScrollToPin": function (payload) {
                    var id = payload.id;
                ...
                "onOpenFeedbackPanel": function () {
                    if (!feedbackOpened()) {
                        $axure.player.showPlugin(feedbackPluginGid);
                    }
                },

                "onCopyCloudCommentLink": function (payload) {
            ...
            $axure.player.toggleCommentMode = function () {
                if (axFeedback) {
                    axFeedback.toggleCommentMode();
                }
            };
            ...
            axFeedback = AxLib.mount($tempWrapper[0], AxLib.Feedback, { ...props, ...handlers });
